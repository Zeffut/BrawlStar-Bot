...
def _cmd_session_push_max(args: dict) -> dict:
    ...
    if args.get("per_brawler_max_trophies") is not None:
        body["per_brawler_max_trophies"] = int(args["per_brawler_max_trophies"])
    if args.get("efficiency_ceiling") is not None:
        body["efficiency_ceiling"] = int(args["efficiency_ceiling"])
